...
def task1(ti):
    #run the pipeline
    res = createrun('test-workspace-airflow-poc', 'samplepipeline', tenantid, clientid, clientsecret)
...
dag = DAG(dag_id='firstsynapseDAG', default_args=default_args, catchup=False, schedule_interval='@once')
